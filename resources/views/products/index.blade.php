<x-app-layout>
    <x-slot name="title">{{ __('Tous nos Sound Tags - Produits') }}</x-slot>
    <x-slot name="metaDescription">{{ __('Découvrez tous nos tags NFC sonores. 10 variantes uniques pour surprendre vos amis.') }}</x-slot>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="text-center">
                ...
                <p class="text-xl text-gray-300 max-w-2xl mx-auto">
                    {{ __('Découvrez tous nos tags NFC avec des sons uniques pour surprendre vos proches.') }}
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 lg:py-16">
        <div>
            <h2 class="text-center text-xl font-bold text-gray-400 mb-10">
                {{ __('Les prévisualisations des Sound Tags sont fortes, baissez le volume.') }}
            </h2>
        </div>
            ...
            @else
                ...
                <div class="text-center py-16">
                    ...
                    <p class="text-gray-400 mb-6">
                        {{ __('Essayez de modifier vos filtres ou revenez plus tard.') }}
                    </p>
                    <a
