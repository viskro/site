<x-app-layout>
    <x-slot name="title">{{ __('Mon Panier') }}</x-slot>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="flex items-center justify-between mb-8">
                    <h1 class="font-display font-bold text-4xl text-white">{{ __('Mon Panier') }}</h1>
                    @if(!$cartItems->isEmpty())
                        <div class="text-gray-400">
                            {{ $cartItems->sum('quantity') }} {{ __('article(s)') }}
                        </div>
                    @endif
                </div>
                ...
                @if($cartItems->isEmpty())
                    ...
                    <div class="bg-gray-800 rounded-2xl border border-gray-700 p-12 text-center">
                        ...
                        <h2 class="text-2xl font-bold text-white mb-4">{{ __('Votre panier est vide') }}</h2>
                        <p class="text-gray-400 mb-8">{{ __('Découvrez nos sound tags et packs pour commencer vos achats !') }}</p>
                        <div class="space-y-3">
                            <a href="{{ route('home') }}" class="inline-flex items-center px-6 py-3 bg-white text-black font-semibold rounded-full hover:bg-gray-100 transition-colors">
                                {{ __('Voir les Sound Tags') }}
                            </a>
                            <a href="{{ route('packs.index') }}" class="inline-flex items-center px-6 py-3 border border-gray-600 text-white font-semibold rounded-full hover:border-gray-500 transition-colors ml-4">
                                {{ __('Voir les Packs') }}
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                                    ...
                                                    @if($item['product_type'] === 'pack' && !empty($item['selected_tags_details']))
                                                        <div class="mb-4 p-4 bg-gray-700 rounded-lg">
                                                            <h4 class="text-sm font-medium text-gray-300 mb-3">
                                                                {{ __('Sound Tags inclus dans ce pack:') }}
                                                            </h4>
                        ...
                        <div class="lg:col-span-1">
                            <div class="bg-gray-800 rounded-2xl border border-gray-700 p-6 sticky top-8">
                                <h2 class="font-display font-bold text-xl text-white mb-6">{{ __('Récapitulatif') }}</h2>
